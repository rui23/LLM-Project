...
small_and_beautiful_theme = gr.themes.Soft(
        primary_hue=gr.themes.Color(
            # c50="#02C160",
            c50="#ffc28a",
            c100="rgba(254, 163, 77, 0.2)",
            c200="#ffc28a",
            c300="rgba(254, 163, 77, 0.32)",
            c400="rgba(254, 163, 77, 0.32)",
            c500="rgba(254, 163, 77, 1.0)",
            c600="rgba(254, 163, 77, 1.0)",
            c700="rgba(254, 163, 77, 0.32)",
            c800="rgba(254, 163, 77, 0.32)",
            c900="#ffc28a",
            c950="#ffc28a",
        ),
